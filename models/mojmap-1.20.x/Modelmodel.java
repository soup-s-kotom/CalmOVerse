	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(12, 12)
						...
						.addBox(-3.0F, -3.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(12, 16)
						.addBox(-1.6503F, 0.5462F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 0)
						.addBox(-2.1503F, -1.6538F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0241F, -1.9047F, -0.3F, -1.5708F, -1.3439F, 1.5708F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 18).addBox(-1.8819F, -0.8524F, -2.0F, 0.0F, 2.0F, 4.0F,
		...
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(18, 2)
						.addBox(3.0F, -5.3F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 6)
						.addBox(3.5F, -7.5F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.2759F, 4.0953F, 0.0F, 0.0F, 0.0F, -0.2269F));

		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(18, 4).addBox(3.0F, -6.7F, -2.0F, 0.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(12, 18)
						.addBox(-1.6503F, 0.5462F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
						.addBox(-2.1503F, -1.6538F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0241F, -1.9047F, 0.3F, 1.5708F, 1.3439F, 1.5708F));

		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 22).addBox(-1.8819F, -0.8524F, -2.0F, 0.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0241F, -1.9047F, 0.3F, 1.5708F, 1.4399F, 1.5708F));

		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(8, 20)
						.addBox(-3.0F, -5.3F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 16)
						.addBox(-3.5F, -7.5F, -2.0F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2759F, 4.0953F, 0.0F, 0.0F, 0.0F, 0.2269F));

		PartDefinition cube_r8 = bb_main.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(16, 20).addBox(-3.0F, -6.7F, -2.0F, 0.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0694F, 4.0389F, 0.0F, 0.0F, 0.0F, 0.1309F));
