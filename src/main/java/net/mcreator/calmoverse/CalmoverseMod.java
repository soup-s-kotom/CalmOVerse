...
import net.mcreator.calmoverse.init.CalmoverseModProcedures;
...
public class CalmoverseMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger();
	public static final String MODID = "calmoverse";

	@Override
	public void onInitialize() {
		LOGGER.info("Initializing CalmoverseMod");
		...
		CalmoverseModBiomes.load();

		CalmoverseModPaintings.load();
		CalmoverseModProcedures.load();
